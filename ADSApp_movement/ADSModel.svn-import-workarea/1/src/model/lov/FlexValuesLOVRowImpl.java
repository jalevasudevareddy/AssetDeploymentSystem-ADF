...
// ---------------------------------------------------------------------
public class FlexValuesLOVRowImpl extends ViewRowImpl {
    /**
    ...
    public Long getFlexValueSetId() {
        return (Long) getAttributeInternal(FLEXVALUESETID);
    }
    ...
    public Long getFlexValueId() {
        return (Long) getAttributeInternal(FLEXVALUEID);
    }
