...
// ---------------------------------------------------------------------
public class ProjectsLOVRowImpl extends ViewRowImpl {
    /**
     ...
     */
    public BigDecimal getCarryingOutOrganizationId() {
        return (BigDecimal) getAttributeInternal(CARRYINGOUTORGANIZATIONID);
    }
