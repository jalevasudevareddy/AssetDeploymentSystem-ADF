...
// ---------------------------------------------------------------------
public class LookupTypesVORowImpl extends ViewRowImpl {
    ...
    public static final int TRANSAPPLICATIONNAME = AttributesEnum.TransApplicationName.index();
    public static final int TRANSLOOKUPTYPE = AttributesEnum.TransLookupType.index();
    ...
    public static final int LOOKUPVALUESVO = AttributesEnum.LookupValuesVO.index();
    public static final int APPLICATIONNAMELOVVO1 = AttributesEnum.ApplicationNameLOVVO1.index();
    public static final int LOOKUPTYPENEWLOVVO1 = AttributesEnum.LookupTypeNewLOVVO1.index();
    ...
    /**
     * Gets the attribute value for the calculated attribute TransApplicationName.
     * @return the TransApplicationName
     */
    public String getTransApplicationName() {
        return (String) getAttributeInternal(TRANSAPPLICATIONNAME);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransApplicationName.
     * @param value value to set the  TransApplicationName
     */
    public void setTransApplicationName(String value) {
        setAttributeInternal(TRANSAPPLICATIONNAME, value);
    }

    /**
     * Gets the attribute value for the calculated attribute TransLookupType.
     * @return the TransLookupType
     */
    public String getTransLookupType() {
        return (String) getAttributeInternal(TRANSLOOKUPTYPE);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransLookupType.
     * @param value value to set the  TransLookupType
     */
    public void setTransLookupType(String value) {
        setAttributeInternal(TRANSLOOKUPTYPE, value);
    }

    /**
     * Gets the associated <code>RowIterator</code> using master-detail link LookupValuesVO.
     */
    public RowIterator getLookupValuesVO() {
        return (RowIterator) getAttributeInternal(LOOKUPVALUESVO);
    }

    /**
     * Gets the view accessor <code>RowSet</code> ApplicationNameLOVVO1.
     */
    public RowSet getApplicationNameLOVVO1() {
        return (RowSet) getAttributeInternal(APPLICATIONNAMELOVVO1);
    }

    /**
     * Gets the view accessor <code>RowSet</code> LookupTypeNewLOVVO1.
     */
    public RowSet getLookupTypeNewLOVVO1() {
        return (RowSet) getAttributeInternal(LOOKUPTYPENEWLOVVO1);
    }
}
