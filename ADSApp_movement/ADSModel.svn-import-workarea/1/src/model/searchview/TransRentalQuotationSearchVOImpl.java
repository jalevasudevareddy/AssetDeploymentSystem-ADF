...
// ---------------------------------------------------------------------
public class TransRentalQuotationSearchVOImpl extends ProgrammaticViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public TransRentalQuotationSearchVOImpl() {
    }
    ...
    public Collection<Object> getScrollableData(ScrollableDataFilter filter) {
        ...
        row.put("TransQuotationNumber", null);
        row.put("TransQuoteStatus", null);
        row.put("TransQuoteStatusCode", null);
