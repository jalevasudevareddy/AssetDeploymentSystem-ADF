...
// ---------------------------------------------------------------------
public class ReceiptSearchVORowImpl extends ViewRowImpl {
    ...
    public static final int TRANSSOURCEDIVISION = AttributesEnum.TransSourceDivision.index();
    ...
    /**
     * Gets the attribute value for the calculated attribute TransSourceDivision.
     * @return the TransSourceDivision
     */
    public String getTransSourceDivision() {
        return (String) getAttributeInternal(TRANSSOURCEDIVISION);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransSourceDivision.
     * @param value value to set the  TransSourceDivision
     */
    public void setTransSourceDivision(String value) {
        setAttributeInternal(TRANSSOURCEDIVISION, value);
    }
