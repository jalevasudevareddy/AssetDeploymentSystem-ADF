...
// ---    Fri Dec 09 11:09:25 IST 2022
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TransAssetAllocationSearchVORowImpl extends ProgrammaticViewRowImpl {
    /**
    ...
    public static final int TRANSALLOCATIONDATE = AttributesEnum.TransAllocationDate.index();
    ...
    public static final int ALLOCATIONNUMBERLOV1 = AttributesEnum.AllocationNumberLOV1.index();
     ...
     */
    public TransAssetAllocationSearchVORowImpl() {
    }
     ...
     */
    public String getTransAllocationNumber() {
        return (String) getAttributeInternal(TRANSALLOCATIONNUMBER);
    }
     ...
     */
    public void setTransAllocationNumber(String value) {
        setAttributeInternal(TRANSALLOCATIONNUMBER, value);
    }

    /**
     * Gets the attribute value for the calculated attribute TransAllocationDate.
     * @return the TransAllocationDate
     */
    public Date getTransAllocationDate() {
        return (Date) getAttributeInternal(TRANSALLOCATIONDATE);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransAllocationDate.
     * @param value value to set the  TransAllocationDate
     */
    public void setTransAllocationDate(Date value) {
        setAttributeInternal(TRANSALLOCATIONDATE, value);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> AllocationNumberLOV1.
     */
    public RowSet getAllocationNumberLOV1() {
        return (RowSet) getAttributeInternal(ALLOCATIONNUMBERLOV1);
    }
