...
// ---------------------------------------------------------------------
public class TransBillingsearchVOImpl extends ProgrammaticViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public TransBillingsearchVOImpl() {
    }
    ...
    public Collection<Object> getScrollableData(ScrollableDataFilter filter) {
        ...
        row.put("TransBillDate", null);
        
        row.put("TransBillNumber", null);
