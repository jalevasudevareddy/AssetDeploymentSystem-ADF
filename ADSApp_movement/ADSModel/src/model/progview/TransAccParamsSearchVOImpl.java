...
// ---------------------------------------------------------------------
public class TransAccParamsSearchVOImpl extends ProgrammaticViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public TransAccParamsSearchVOImpl() {
    }
    ...
    public Collection<Object> getScrollableData(ScrollableDataFilter filter) {
        ...
        row.put("TransLedgerId", null);
        row.put("TransSetId", null);
        row.put("TransDivisionRequired", null);
        row.put("TransDivisionSegment", null);
