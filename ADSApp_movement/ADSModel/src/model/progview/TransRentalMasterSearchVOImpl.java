...
// ---    Tue Oct 25 14:23:18 IST 2022
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TransRentalMasterSearchVOImpl extends ProgrammaticViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public TransRentalMasterSearchVOImpl() {
    }
    ...
    //        return value;
        ...
        row.put("TransFlexValueId", null);
        row.put("TransFlexValueSetId", null);
        row.put("TransDivisionRequired", null);
        row.put("TransBuCurrency", null);
        row.put("TransDivSegmentNum", null);
        row.put("TransPrecision", null);
