...
// ---    Mon Oct 10 18:11:17 IST 2022
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XxadsLookupTypesEOImpl extends EntityImpl {
    /**
    ...
    public static final int XXADSLOOKUPVALUESEO = AttributesEnum.XxadsLookupValuesEO.index();

    /**
     * This is the default constructor (do not remove).
     */
    public XxadsLookupTypesEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("model.entity.XxadsLookupTypesEO");
    }


    protected void create(AttributeList attributeList) {
        super.create(attributeList);
        SequenceImpl seq = new SequenceImpl("xxcust_lookup_types_s",this.getDBTransaction());
        setLookupTypeId(seq.getSequenceNumber());
    }
    ...
    /**
     * Gets the attribute value for LookupTypeId, using the alias name LookupTypeId.
     * @return the value of LookupTypeId
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for LookupTypeId.
     ...
     */
    public RowIterator getXxadsLookupValuesEO() {
        return (RowIterator) getAttributeInternal(XXADSLOOKUPVALUESEO);
    }

    /**
     * @param lookupTypeId key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(Number lookupTypeId) {
        return new Key(new Object[] { lookupTypeId });
    }
