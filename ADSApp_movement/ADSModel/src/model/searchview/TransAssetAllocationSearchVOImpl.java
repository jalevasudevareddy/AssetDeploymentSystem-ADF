...
// ---------------------------------------------------------------------
public class TransAssetAllocationSearchVOImpl extends ProgrammaticViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public TransAssetAllocationSearchVOImpl() {
    }
    ...
    public Collection<Object> getScrollableData(ScrollableDataFilter filter) {
        ...
        row.put("TransAllocationNumber", null);
        row.put("TransAllocationDate", null);
