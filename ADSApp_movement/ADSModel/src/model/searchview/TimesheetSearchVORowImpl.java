...
// ---------------------------------------------------------------------
public class TimesheetSearchVORowImpl extends ViewRowImpl {
    ...
    public static final int TRANSTSNUMBER = AttributesEnum.TransTsNumber.index();
     ...
     */
    public TimesheetSearchVORowImpl() {
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute TransTsNumber.
     * @return the TransTsNumber
     */
    public Number getTransTsNumber() {
        return (Number) getAttributeInternal(TRANSTSNUMBER);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransTsNumber.
     * @param value value to set the  TransTsNumber
     */
    public void setTransTsNumber(Number value) {
        setAttributeInternal(TRANSTSNUMBER, value);
    }
