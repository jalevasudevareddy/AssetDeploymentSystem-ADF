...
import model.entity.AssetDepReceiptMobilizationEOImpl;
...
// ---------------------------------------------------------------------
public class DeploymentRcptMobilizationVORowImpl extends ViewRowImpl {


    public static final int ENTITY_ASSETDEPRECEIPTMOBILIZATIONE1 = 0;
     ...
     */
    public DeploymentRcptMobilizationVORowImpl() {
    }

    /**
     * Gets AssetDepReceiptMobilizationE1 entity object.
     * @return the AssetDepReceiptMobilizationE1
     */
    public AssetDepReceiptMobilizationEOImpl getAssetDepReceiptMobilizationE1() {
        return (AssetDepReceiptMobilizationEOImpl) getEntity(ENTITY_ASSETDEPRECEIPTMOBILIZATIONE1);
    }
    ...
    /**
     * Gets the attribute value for DR_MOBILIZATION_ID using the alias name DrMobilizationId.
     * @return the DR_MOBILIZATION_ID
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for DR_MOBILIZATION_ID using the alias name DrMobilizationId.
     * @param value value to set the DR_MOBILIZATION_ID
     */
